    ...
    <div className="flex min-h-full flex-1 flex-col justify-center px-6 py-12 lg:px-8 bg-[var(--brand-light)]">
      ...
      <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
        <form className="space-y-6" action="#" method="POST">
          ...
          <div>
            <label htmlFor="accountType" className="block text-sm font-medium leading-6 text-[var(--brand-dark)]">
              Account Type
            </label>
            <div className="mt-2">
              <select
                ...
                name="accountType"
                required
                className="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-[var(--brand-primary)] sm:text-sm sm:leading-6"
              >
        ...
        <p className="mt-10 text-center text-sm text-gray-500">
          Already a member? {' '}
          <Link href="/login" className="font-semibold leading-6 text-[var(--brand-primary)] hover:text-[var(--brand-secondary)]">
            Sign in
          </Link>
        </p>
      </div>
