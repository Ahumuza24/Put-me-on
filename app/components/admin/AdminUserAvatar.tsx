...
const AdminUserAvatar: React.FC<AdminUserAvatarProps> = ({ className }) => {
    ...
    const getDisplayName = () => {
        return profile?.fullName || user?.email?.split('@')[0] || 'Admin'
    }
        ...
        <DropdownMenu>
            <DropdownMenuTrigger asChild>
                <Button
                    variant="ghost"
                    className={cn(
                        "flex items-center space-x-3 px-3 py-2 h-auto hover:bg-muted/50 transition-colors w-full",
            ...
            >
                ...
                <DropdownMenuItem asChild>
                    <Link to="/admin/settings" className="flex items-center space-x-2 px-3 py-2">
                ...
                <DropdownMenuItem asChild>
                    <Link to="/admin/dashboard" className="flex items-center space-x-2 px-3 py-2">
